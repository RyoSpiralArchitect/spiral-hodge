...
ENERGY_METRICS = [
    ...
    ("hltd_same_graph_reverse_coexact_ratio_gap", "HLTD same-graph reverse gap"),
...
DEFAULT_NULL_METRICS = [
    ...
    ("hltd_same_graph_reverse_coexact_ratio_gap", "HLTD same-graph reverse coexact gap"),
    ("hltd_same_graph_reverse_semantic_flow_ratio_gap", "HLTD same-graph reverse flow gap"),
    ("hltd_same_graph_reverse_coexact_alignment", "HLTD same-graph reverse coexact alignment"),
  ...
  <script>
    ...
    function renderTables() {{
      ...
      const columns = [
        ...
        ["hltd_same_graph_reverse_coexact_ratio_gap", "HLTD sg-rev gap"],
