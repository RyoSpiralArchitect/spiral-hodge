...
def write_steering_metrics(path: Path) -> None:
    ...
    rows = [
        ["ontology_01", 5, 4, " road", " and", "coexact", 1.0, 1, 0.09, 0.02, -0.2, 1, 2.0, 0.4, ""],
        ["ontology_01", 5, 4, " road", " and", "random_tangent", 1.0, 1, 0.14, 0.03, -0.1, 1, 3.0, -0.3, ""],
        ["ontology_01", 5, 4, " road", " and", "presence", 1.0, 1, 0.12, 0.025, -0.3, 1, 2.5, 0.1, ""],
    ]
